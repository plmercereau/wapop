...
# wifi.platyplus.io/wapop-bundle:$VERSION and wifi.platyplus.io/wapop-catalog:$VERSION.
IMAGE_TAG_BASE ?= plmercereau/wapop
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name wapop-builder
	$(CONTAINER_TOOL) buildx use wapop-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm wapop-builder
	rm Dockerfile.cross
